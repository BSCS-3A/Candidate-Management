                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap;">
                                                <button class="btn btn-primary btn-xs" data-title="Edit" data-target="#edit" data-placement="top" data-toggle="tooltip" title="Edit" ><span class="fa fa-edit"> <a href="../database/editCandidate.php?id=<?php echo $row['candidate_id']?>">EDIT</a></span></button>
                                                <button class="btn btn-danger btn-xs" data-title="Delete" data-target="#delete"  data-placement="top" data-toggle="tooltip" title="Delete" ><span class="fa fa-trash-alt"></span><a href="../database/deleteCandidate.php?id=<?php echo $row['candidate_id']?>">DELETE</a></button>
                                            </td>
                                        </tr>
                                <?php
                                        }
 ...
 ?>
  ...
  <!-- /.modal-dialog -->  
      ...
      <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
          ...
          <div class="modal-content">
                ...
                <form action="../database/addCandidate.php" method = "POST" autocomplete = "off">
                    <div class="modal-body">
                        ...
                        <div class="form-group">  
                            <input class="form-control " id= "etc-add2" name="platform" type="text" placeholder="Enter Platforms" required>              
                        </div>
                        <div class="form-group">  
                            <input class="form-control " id= "etc-add3" name="credentials" type="text" placeholder="Enter Credentials" required>              
                        </div> 
                    </div>
          ...
          <div class="modal-content">
                ...
                <form action="../database/addCandidate.php" method = "POST" autocomplete = "off">
                    <div class="modal-body">
                            ...
                            <?php
                                ...
                                if(mysqli_num_rows($result)> 0){
                                    ...
                                    if(isset($_GET['candidateid'])){
                                        ...
                                        $sql_candidate_id = "SELECT position_name FROM `candidate_position` WHERE candidate_id ='$candidateid'";
                                        $result_candidate_id = mysqli_query($conn,$sql);
                                        $row_candidate_id = mysqli_fetch_assoc($result_candidate_id);
                                        echo "<option value = '".$candidateid."'>".$row_candidate_id['position_name']."</option>";
                                        while($rowposition = mysqli_fetch_assoc($result)){
                                            if($i != $rowposition['heirarchy_id']){
                        ...
                        <div class="form-group">  
                            <input class="form-control" id="etc-edit2" name="editplatform" type="text" value="<?php if(isset($_GET['candidateid'])){echo $_GET['platform'];}?>" placeholder="Enter Platforms" required>              
                        </div>
                        <div class="form-group">  
                            <input class="form-control" id="etc-edit3" name="editcredentials" type="text" value="<?php if(isset($_GET['candidateid'])){echo $_GET['credentials'];}?>" placeholder="Enter Credentials" required>              
                        </div>
                    </div>
                    <div class="modal-footer ">
          ...
          <form action="../database/confirmDeleteCandidate.php?id=<?php echo $_GET['id'];?>" method="POST">
              <div class="modal-footer ">
