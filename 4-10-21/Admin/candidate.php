    ...
    <div class="btn-toolbar" style="margin-left: 18px;">
      ...
      <table class= "center" id="datatable" width="100%" cellspacing="0" cellpadding="2px">
                          ...
                          <tbody>
                                ...
                                ?>
                                        <tr>
                                            <form action="../database/uploadphoto.php?id=<?php echo $row['candidate_id']?>" method="POST" enctype="multipart/form-data">
                                            <?php 
                                            ...
                                            <td style="white-space: nowrap;">
                                                <button class="btn btn-primary btn-xs" data-title="Edit" data-target="#edit" data-placement="top" data-toggle="tooltip" title="Edit" ><span class="fa fa-edit"></span> <a href="../database/editCandidate.php?id=<?php echo $row['candidate_id']?>">EDIT</a></button>
