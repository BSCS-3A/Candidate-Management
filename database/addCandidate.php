<?php
    ...
    if(isset($_POST['edit-save-btn'])){
        $lastname = $_POST['editlastnamesearch'];
        $firstname = $_POST['editfirstnamesearch'];
        $heirarchyid = $_POST['editpositionlist'];
        $partylist = $_POST['editpartylist'];
